      ...
      <nav class="navbar bg-secondary navbar-dark">
        ...
        <div class="navbar-nav w-100">
          ...
          <router-link to="/admin/transaction" class="nav-item nav-link"   :class="{
            ...
            ><i class="fa fa-chart-bar me-2"></i>Transaction</router-link
          >
          <router-link to="/admin/leads" class="nav-item nav-link"   :class="{
              active: this.$route.path === '/admin/leads',
            }"
            ><i class="fa fa-comment me-2"></i>Contact Us</router-link
          > -->
          ...
          <div class="nav-item dropdown">
            ...
            >
              <img
                ...
                style="width: 40px; height: 40px"
              />
              <span class="d-none d-lg-inline-flex">ddddddddddd</span>
            </a>
            <div
