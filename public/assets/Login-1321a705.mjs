...
import { _ as _sfc_main$1 } from "./AuthenticationCardLogo-3838be1f.mjs";
import { _ as _sfc_main$5 } from "./Checkbox-74b17051.mjs";
import { _ as _sfc_main$3, a as _sfc_main$4 } from "./TextInput-eebab1fc.mjs";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Log in page" }, null, _parent));
